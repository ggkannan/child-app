...
define('dummy/tests/acceptance/child-app-test', ['qunit', 'dummy/tests/helpers/module-for-acceptance'], function (_qunit, _moduleForAcceptance) {
  'use strict';

  (0, _moduleForAcceptance.default)('Acceptance | child app');

  (0, _qunit.test)('visiting /child-app', function (assert) {
    visit('/child-app');
...
define('dummy/tests/tests.lint-test', [], function () {
  ...
  QUnit.test('acceptance/child-app-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'acceptance/child-app-test.js should pass ESLint\n\n');
  });
  ...
  QUnit.test('unit/routes/child-home-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/child-home-test.js should pass ESLint\n\n');
  });

  QUnit.test('unit/routes/child-home1-test.js', function (assert) {
    assert.expect(1);
    assert.ok(true, 'unit/routes/child-home1-test.js should pass ESLint\n\n');
  });
});
...
define('dummy/tests/unit/models/house-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';
...
define('dummy/tests/unit/routes/child-home-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';

  (0, _emberQunit.moduleFor)('route:child-home', 'Unit | Route | child home', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
...
define('dummy/tests/unit/routes/child-home1-test', ['ember-qunit'], function (_emberQunit) {
  'use strict';

  (0, _emberQunit.moduleFor)('route:child-home1', 'Unit | Route | child home1', {
    // Specify the other units that are required for this test.
    // needs: ['controller:foo']
  });
